          ...
          <div class="card card-secondary">
            <form action="/admin/{{$action ?? ''}}" method="post" enctype="multipart/form-data">
              ...
              @if (!empty($method))
                  @method($method)
              @endif
              <a href="/admin/menu" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> New Menu</a>
        ...
        columns: [
            ...
            { 
                ...
                render: function(data,type,full,meta){
                   return '<div class="form-inline"><a href="/admin/menucustom/'+data+'" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i> Customize</a>|<a href="/admin/menu/'+data+'/edit/" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i> Edit</a> | <form action="/admin/menu/'+data+'" method="post"> @csrf @method("DELETE") <button class="btn btn-sm btn-danger"><i class="fa fa-trash"></i> Delete</button></form></div>';
                },
                orderable: false
            }
        ],
