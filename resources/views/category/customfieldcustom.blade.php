...
<section class="content">
    <div class="row">
        <div class="col-md-8">
            <div class="card mb-3">
                <div class="card-header"><h5 class="float-left">Custom Field</h5>
                ...
                <div class="card-body">
                    <form id="frmEdit" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="options" class="form-control item-menu" id="options" placeholder="separate with coma">
                        </div>
                        <div class="form-group">
                            <label for="placeholder">Placeholder</label>
                            <input type="text" name="placeholder" class="form-control item-menu" id="placeholder" placeholder="Placeholder">
                        </div>
                    </form>
                </div>
                <div class="card-footer">
